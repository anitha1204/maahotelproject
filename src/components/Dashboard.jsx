    ...
    return (
        <div className="flex min-h-screen bg-gray-100">
            ...
            <main className="flex-1 p-6">
                ...
                {/* Overview Section */}
                <section className="grid grid-cols-4 gap-6 my-4 bg-white px-4 py-6 shadow-sm rounded-3xl text-white">
                    <h2 className="col-span-4 text-xl ml-4">Overview</h2> {/* Adjusted heading */}

                    <div className="bg-green-500 p-4 rounded-lg text-center">
                        <h3 className="text-[12px] font-semibold text-start">Today's Check In</h3>
                        <p className="text-5xl text-end">12</p>
                        <h3 className="text-[12px] font-semibold text-start">View Booking dates</h3>
                    </div>

                    <div className="bg-red-500 p-4 rounded-lg text-center">
                        <h3 className="text-[12px] font-semibold text-start">Today's Check Out</h3>
                        <p className="text-5xl text-end">05</p>
                        <h3 className="text-[12px] font-semibold text-start">View Booking dates</h3>
                    </div>

                    <div className="bg-blue-500 p-4 rounded-lg text-center">
                        <h3 className="text-[12px] font-semibold text-start">Rooms Available</h3>
                        <p className="text-5xl text-end">17</p>
                        <h3 className="text-[12px] font-semibold text-start">View Booking dates</h3>
                    </div>

                    <div className="bg-orange-500 p-4 rounded-lg text-center">
                        <h3 className="text-[12px] font-semibold text-start">Rooms Reserved</h3>
                        <p className="text-5xl text-end">03</p>
                        <h3 className="text-[12px] font-semibold text-start">View Booking dates</h3>
                    </div>
                </section>
